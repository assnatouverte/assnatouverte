...
export const commands: Commands = {
  "assnat": {
    desc: "Télécharge tous les journaux de débats depuis le site web de l'Assemblée nationale du Québec",
...
export async function taskExtractTextFromHansard(ctx: CommandContext): Promise<number> {
  const legislature = 42;
  const session = 1;
